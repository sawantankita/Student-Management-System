...
<body style="background-image:url('bg2.JPG');font-family:Century Gothic;">
	<div class="d1" style="margin-left:500px;margin-top:10px;">
	<center><br><br>
		<h3 style="margin-top:70px;">Admin LogIn Page</h3><br>
		<form action="" method="post">
			...
			<input class="bb" type="submit" name="submit" value="LogIn">
	</div>
		</form><br>
